...
<body>
	...
	<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				<div class="login-center-img">
					<img src="../resources/admin/login/images/cpache.png">
				</div>
				<div class="login-center-input">
					<input style="width: 50%" type="text" name="cpache" id="cpache" value="" placeholder="请输入验证码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入验证码&#39;">
					<div class="login-center-input-text">验证码</div>
					<img id="cpache-img" style="cursor: pointer;" title="点击切换验证码" width="110px;" height="30ps;" alt="" src="get_cpacha?vl=4&w=110&h=30&type=loginCpacha" onclick="changeCpacha()">
				</div>
			</div>
	...
	function changeCpacha(){
		$("#cpache-img").attr("src",'get_cpacha?vl=4&w=110&h=30&type=loginCpacha&t='+new Date().getTime());
	}
