...
<body class="easyui-layout">
						...
						<c:forEach items="${secondMenuList }" var="secondMenu">
							<c:if test="${secondMenu.parentId == topMenu.id}">
								<li iconCls="icon-chart-organisation">
									<a href="javascript:void(0)" data-icon="${secondMenu.icon }" data-link="${secondMenu.url }?_mid=${secondMenu.id}" iframe="1">${secondMenu.name }</a>
								</li>
							</c:if>
						</c:forEach>
					</ul>
	...
	<!-- end of main -->
	<!-- begin of footer -->
	<div class="wu-footer" data-options="region:'south',border:true,split:true">&copy; 2020 link All Rights Reserved</div>
	<!-- end of footer -->
